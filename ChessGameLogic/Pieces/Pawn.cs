...
namespace ChessGameLogic
{
    public class Pawn:Piece
    {
        ...
        {
            yield return new PawnPromotions(from, to,PieceType.Knight);
            yield return new PawnPromotions(from, to,PieceType.Bishop);
            yield return new PawnPromotions(from, to,PieceType.Queen);
            yield return new PawnPromotions(from, to,PieceType.Rook);
        }
        ...
        private IEnumerable<Move> DiagonalMoves(Position from, Board board)
        {
            foreach (var dir in new Direction[] { Direction.West, Direction.East })
            {
                ...
                if(to == board.GetPawnSkipPosition(Color.PlayerOpponent()))
                {
